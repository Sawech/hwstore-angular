...
export class HomeComponent implements OnInit {
  ...
  readonly features = [
    {
      ...
      description:
        "Tous nos produits bénéficient d'une couverture complète pour une tranquillité d'esprit totale.",
    },
    {
      icon: 'local_shipping',
    ...
    },
    {
      icon: 'shield',
      title: 'Authenticité',
      description: 'Garantie de produits 100% originaux aux prix les plus compétitifs du marché.',
    },
  ];
  ...
  readonly testimonials = [
    ...
    {
      quote:
        '\"Des prix honnêtes et des produits authentiques. C\'est rare de trouver cette qualité de service en Algérie. Je recommande vivement !\"',
      name: 'Mohamed B.',
